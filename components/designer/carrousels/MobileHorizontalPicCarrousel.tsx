...
import styles from "./MobileHorizontalPIcCarrousel.module.scss";
...
function MobileHorizontalPicCarrousel() {
  ...
  return (
    <main className={styles.main}>
      <div className={styles.carrouselSlider}>
        <div className={styles.imageSliderHorizontalMobile}>
          <Slider
            {...settingsHorizontal}
...
export default MobileHorizontalPicCarrousel;
